...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.8]{Imagens/crash2.png}
 \caption{Captura de tela do jogo Crash Bandicoot}
 \label{img:crash2}
\end{figure}
...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.8]{Imagens/mario1.png}
...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.8]{Imagens/mario2.png}
 \caption{Captura de tela do jogo Super Mário Galaxy}
 \label{img:mario2}
\end{figure}
...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.7]{Imagens/zelda1.png}
...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.7]{Imagens/zelda2.png}
 \caption{Captura de tela do jogo Legend of Zelda}
 \label{img:zelda2}
\end{figure}
...
\begin{figure}[!ht]
 \centering
 \includegraphics[scale=0.8]{Imagens/pit1.png}
